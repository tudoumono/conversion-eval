...
FIELD_LABELS = {
    ...
    "uses_ocr": "OCR使用",
    "force_full_page_ocr": "ページ全体OCR",
    "uses_internal_models": "内部モデル使用",
    "allow_network_download": "ネットワーク取得許可",
    "input_pdf_type": "PDF種別",
    "input_encoding_detected": "検出文字コード",
    "preprocess_time_sec": "形式変換時間_秒",
    "preprocess_success": "形式変換成功",
    "preprocess_error": "形式変換エラー",
    "preprocess_timeout": "形式変換タイムアウト",
    "intermediate_size_bytes": "形式変換後ファイルサイズ_バイト",
    "markdown_input_file": "Markdown変換入力ファイル",
    "markdown_input_extension": "Markdown変換入力拡張子",
    "convert_time_sec": "Markdown変換時間_秒",
    "convert_success": "Markdown変換成功",
    "convert_error": "Markdown変換エラー",
    "convert_timeout": "Markdown変換タイムアウト",
